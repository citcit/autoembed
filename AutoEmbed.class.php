...
class AutoEmbed {
  ...
  /**
   * Check to see if the link is an image, if not
   */
  public function isImage($url) {
    $header = get_headers($url, 1);
    return ( preg_match('/image/', $header['Content-Type']) );
  }
  ...
  private function _buildObject() {
    ...
    if ($this->_media_type == self::IMAGE) {
